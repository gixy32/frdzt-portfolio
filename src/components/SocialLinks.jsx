...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/frdzt/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@frdzt",
    icon: Instagram,
    url: "https://www.instagram.com/frediazto/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "PurrBerry Server",
    icon: ({ className, ...props }) => (
      <svg viewBox="0 0 127.14 96.36" className={className} {...props}>
        <path
          fill="currentColor"
    ...
    url: "https://discord.gg/purrberry",
    color: "#5865F2",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@frediazto",
    color: "black",
...
const SocialLinks = () => {
  ...
  const [instagram, discord, github, tiktok] = otherLinks;
    ...
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, discord].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
