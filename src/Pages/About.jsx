...
const AboutPage = () => {
  ...
  useEffect(() => {
    const updateStats = () => {
      ...
      const startDate = new Date("2021-11-06"); // TODO: ganti ke tanggal mulai lo sendiri terjun ke dev
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
        Saya adalah developer yang fokus di ekosistem Discord — mulai dari bot commerce, sistem automation, sampai deployment infrastruktur. 
Terbiasa kerja end-to-end: dari nulis bot-nya, ngatur hosting di VPS/Pterodactyl, sampai mastiin semuanya jalan stabil 24/7.
                  </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              {/* TODO: ganti href di bawah dengan link Google Drive CV lo sendiri */}
